...
<div class="main-header">
    ...
    <p>Tác giả: Vàng Văn Đức - Trường PTDTBT TH Sơn Vĩ - ĐT: 038 3362 862</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Vàng Văn Đức - Trường PTDTBT TH Sơn Vĩ - ĐT: 038 3362 862</div>", unsafe_allow_html=True)
